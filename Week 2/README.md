...
Deze week gaat het over **Kubernetes Networking**. We maken een Kubernetes Cluster in Google Cloud en leren hoe het **LoadBalancer** Service-type werkt, en hoe je meerdere apps via een **Ingress** beschikbaar stelt.
